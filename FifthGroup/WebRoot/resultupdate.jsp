        ...
        <TR>
          <TD>
            ...
            cellSpacing=1 cellPadding=2 rules=all border=0>
              ...
              <% if(id.compareTo("add")!=0){
              		TrainResult tr=MyClass.listResult.get(Integer.parseInt(id));
              ...
              <FORM id=form1 name=form1 action="doResultUpdate?change=1"  method="post">
              <TR 
              style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none">
                <center>
                	培训项目id：<input name="trainid" type="text" readonly="readonly" value= <%=tr.getTrainid()%> />  
                </center>
              </TR>
              <TR 
              style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none">
                <center>
                	员  工  id：<input name="workerid" type="text" readonly="readonly" value= <%=tr.getWorkerid()%> />               </center>
              </TR>
              <TR 
              style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none">
                <center>
                	员工姓名：<input name="name" type="text" readonly="readonly" value= <%=LyyDao.getUserName(tr.getWorkerid())%>>      
                </center>
              </TR>
              <TR 
              style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none">
                <center>
                	所得分数：<input name="score" type="text" value= <%=tr.getScore()%>>      
                </center>
              </TR>
              <TR 
              style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none">
              ...
              <%}else{ %>
              <FORM action="doResultUpdate?change=0"  method="post">
         		<TR 
              style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none">
                <center>
                	培训项目id：<input name="trainid" type="text"  />  
                </center>
              </TR>
              ...
              style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none">
                <center>
                	所得分数：<input name="score" type="text" >      
                </center>
              </TR>
              <TR 
              style="FONT-WEIGHT: bold; FONT-STYLE: normal; BACKGROUND-COLOR: #eeeeee; TEXT-DECORATION: none">
